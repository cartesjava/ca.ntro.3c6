...
public abstract class Atelier3_2_3 extends Atelier {

	static {

		new InitializerExercise().initialize(Atelier3_2_3.class);
	}
	...
	public PerformanceTestsDriver createPerformanceTestsDriver() {
		return new TesteurAtelier3_2_3();
	}

	public abstract CalculateurFibonacci fournirFibonacciNaif();

	public abstract CalculateurFibonacci fournirFibonacciEfficace();
