...
public abstract class Atelier5_1 extends Atelier {

	static {

		new InitializerExercise().initialize(Atelier5_1.class);
	}
	...
	protected void performValidation() {
		...
		addMapSubReport(validationReport, "MapNaif", "fournirTesteurDeMapNaif", true);
	}
