...
public abstract class Atelier5_2 extends Atelier {

	static {

		new InitializerExercise().initialize(Atelier5_2.class);
	}
	...
	protected void performValidation() {
		...
		addMapSubReport(validationReport, "MapNaif", "fournirTesteurDeMapNaif", false);
		addMapSubReport(validationReport, "MapHasha", "fournirTesteurDeMapHasha", true);
		addMapSubReport(validationReport, "MapHashb", "fournirTesteurDeMapHashb", true);
		addMapSubReport(validationReport, "MapHashc", "fournirTesteurDeMapHashc", true);
	}
	...
	public PerformanceTestsDriver createPerformanceTestsDriver() {
		return new TesteurAtelier5_2();
	}

	public abstract TesteurDeMap fournirTesteurDeMapNaif();
	public abstract TesteurDeMap fournirTesteurDeMapHasha();
	public abstract TesteurDeMap fournirTesteurDeMapHashb();
	public abstract TesteurDeMap fournirTesteurDeMapHashc();
