...
public class TesteurAtelier4_2 extends PerformanceTestsDriver {
	...
	public TestParameters getTestParametersFor(String providerMethodPrefix, String methodName) {
		...
		if(methodName.equals("fairePlusieursAjouts")) {
			...
			testsParameters = new TestParameters((int) 1E4, (int) 1E4*3, 30, 4.0, true);
			...
			testsParameters = new TestParameters((int) 1E4, (int) 1E4*3, 30, 4.00, true);

		} else if(methodName.equals("fairePlusieursModificationsAleatoires")) {
			
			testsParameters = new TestParameters((int) 1E4, (int) 1E4*3, 30, 4.00, false);
			...
			testsParameters = new TestParameters((int) 1E4, (int) 1E4*3, 30, 12.0, true);
